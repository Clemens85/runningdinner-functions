...
export class SupportBotStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    commonUtils.allowParameterStoreAccess([supportBotFunc.lambdaFunction], PINECONE_API_KEY_PARAM_NAME);
    commonUtils.allowParameterStoreAccess([supportBotFunc.lambdaFunction], OPENAI_API_KEY_PARAM_NAME);
    commonUtils.allowParameterStoreAccess([supportBotFunc.lambdaFunction], LANGSMITH_API_KEY_PARAM_NAME);
    commonUtils.allowParameterStoreAccess([supportBotFunc.lambdaFunction], GEMINI_API_KEY_PARAM_NAME);
  }
