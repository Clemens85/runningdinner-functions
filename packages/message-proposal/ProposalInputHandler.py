...
class ProposalInputHandler:
    def __init__(self, data_accessor: DataAccessor, vector_db_repository: VectorDbRepository, llm: ChatOpenAI):
        self.data_accessor = data_accessor
        self.vector_db_repository = vector_db_repository
        self.anonymizer = Anonymizer(llm=llm)
        self.message_proposal_generator = MessageProposalGenerator(self.vector_db_repository, data_accessor, llm)
